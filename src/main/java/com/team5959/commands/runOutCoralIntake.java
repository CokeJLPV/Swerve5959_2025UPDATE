...
public class runOutCoralIntake extends Command {
  
  intakeCoralSubsystem intakeCoralSubsystem;

  public runOutCoralIntake(intakeCoralSubsystem intakeCoralSubsystem) {
  ...
  @Override
  public void execute() {
    intakeCoralSubsystem.runOutCoralIntake();
  }
